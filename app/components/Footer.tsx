...
export default function Footer() {
    ...
    return (
        <footer className="content-layer relative bg-gradient-to-b from-transparent to-gray-50/50 border-t border-gray-100 mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Joules Technologies</h3>
                            </div>
                        </div>
                        <p className="text-sm text-gray-600 leading-relaxed">
                            Empowering schools with modern digital solutions for efficient management and record keeping.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="/rojmel" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
                                    Rojmel System
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <p className="text-sm text-gray-500">
                            © {currentYear} Joules Technologies. All rights reserved.
                        </p>
                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            <a
                                href="mailto:info@joulestechnologies.com"
